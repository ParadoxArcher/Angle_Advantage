...
func _physics_process(_delta):
	...
	boost_sprite.material.set_shader_parameter("GreenFilterLeft", 1 - GreenFilterLeft)
	print(1 - GreenFilterLeft)
	boost_sprite.material.set_shader_parameter("GreenFilterRight", 1 - GreenFilterRight)
